...
class GameEngine:
    ...
    def stack(self):
        ...
        np.apply_along_axis(move_nonzero_to_left, axis=1, arr=self.matrix)
    ...
    def combine(self):
        ...
        # Apply the function to each row of the matrix
        np.apply_along_axis(add_consecutive_identical_values, axis=1, arr=self.matrix)
